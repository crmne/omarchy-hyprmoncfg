...
Panel {
  ...
  Process {
    ...
    onExited: function(exitCode) {
      ...
      var probedCompatible = probedInstalled && Model.versionAtLeast(versionOutput.text, "1.18.0")
      ...
      if (root.installing && !probedCompatible) {
        ...
        installPoll.stop()
        installTimeout.stop()
        root.lastError = "The update finished, but hyprmoncfg 1.18.0 or newer is still required."
        return
      }
